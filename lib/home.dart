...
import 'dart:async';
import 'package:flutter_sqlite/model/item.dart';
import 'package:flutter_sqlite/entryForm.dart';
import 'package:flutter_sqlite/dbhelper/dbhelper.dart';
...
class HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('DAFTAR ITEM - ANA QONITAH M | 2041720118'),
      ),
      body: Column(
        children: [
          Expanded(
